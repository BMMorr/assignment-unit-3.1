...
let favoriteFoods = ['curry', 'cake', 'ceral'];

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above
console.log('My favortie foods are: ', favoriteFoods);
...
console.log('Second food is: ', favoriteFoods[2])
...
favoriteFoods.unshift('milkshakes');
console.log('Added a food to the beginnning:', favoriteFoods);
...
console.log('Removed a food from the beginnning:', removedFood)
